 ...
 *
 * <h2>为什么需要 proxyBeanMethods=false</h2>
...
public class MyBatisConfig {
     ...
     */
    @Value("${mybatis.log-impl:org.apache.ibatis.logging.stdout.StdOutImpl}")   //org.apache.ibatis.logging.stdout.StdOutImpl 是默认值
    private String logImplClassName;

    /** log-impl 找不到/未配时回退到 StdOutImpl(测试环境 @Value 偶尔返回 null) */
