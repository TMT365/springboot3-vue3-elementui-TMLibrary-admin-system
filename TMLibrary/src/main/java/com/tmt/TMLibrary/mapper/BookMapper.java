...
public interface BookMapper {
     ...
     * @return 包含Book对象的列表
     */
    List<Book> selectListByTitle(@Param("title") String title, @Param("offset") int offset, @Param("limit") int limit);
     ...
     * @return 包含Book对象的列表
     */
    List<Book> selectListByPublishedDate(@Param("publishedDate") LocalDate publishedDate, @Param("offset") int offset,
            @Param("limit") int limit);
     ...
     * @return
     */
    List<Book> selectListByPriceRange(@Param("minPrice") BigDecimal minPrice, @Param("maxPrice") BigDecimal maxPrice,
